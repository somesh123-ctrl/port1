  ...
  const counterData = [
    {
      ...
      value: `${data.user.about.exp_year}`,
      valueType: "plus",
    },
    {
      id: 2,
      text: "Project Complete",
      value: `${data.user.projects.length}`,
      valueType: "k-plus",
    },
        ...
        <div className="row align-items-center">
          <div className="col-lg-4 col-sm-7">
            <div className="hero-content rmb-55 wow fadeInUp delay-0-2s">
              ...
              <h1>
                <b>{data.user.about.name}</b> {data.user.about.title}
              </h1>
              <p>{data.user.about.subTitle}</p>
          ...
          <div className="col-lg-5">
            <div className="author-image-part wow fadeIn delay-0-3s">
              ...
              <img src={data.user.about.avatar.url} alt="Author" />
